/**
 * GlobalKnowledgeBase — Manajemen basis pengetahuan global
...
const GlobalKnowledgeBase: Component<GlobalKnowledgeBaseProps> = (props) => {
  return (
    <div class="global-knowledge-base">
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold">Basis Pengetahuan Global</h3>
        <button
      ...
      {props.entries.length === 0 ? (
        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
          Belum ada entri basis pengetahuan global.
        </div>
      ) : (
        <div class="space-y-3">
